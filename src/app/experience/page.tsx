        ...
        <RevealGroup>
          <RevealItem>
            <div className="relative text-center max-w-3xl px-6">
              ...
              <p className="mt-6 text-base md:text-lg font-light tracking-wide text-white/85 leading-relaxed max-w-3xl mx-auto">
            ...
            <div className="space-y-24">
              ...
              <RevealItem>
                <TimelineItem
                  ...
                  subtitle="Bachelor Project / Independent System Design"
                  icon={<Briefcase size={18} />}
                  color="violet"
                  badge={{ label: "Bachelor Project", variant: "blue" }}
                  achievements={[
                    "Operationalized data drift as an explicit control signal",
                    "Implemented rule-based, auditable model promotion gates",
                    "Built CI-driven lifecycle with full experiment traceability",
                  ]}
                >
                  Designed and implemented a CI-driven MLOps framework where data
                  drift is treated as an explicit decision signal rather than
                  passive monitoring. Candidate models are evaluated in isolation
                  and promoted only through predefined, auditable criteria.
                </TimelineItem>
              </RevealItem>
              ...
              <RevealItem>
                <TimelineItem
                  ...
                  color="indigo"
                  badge={{ label: "Ongoing Education", variant: "orange" }}
                  achievements={[
                    "Strong foundation in machine learning and data analysis",
                    "Focused on reproducibility and structured system design",
                    "Bridged academic theory with production constraints",
                  ]}
                >
                  Formal education focused on applied machine learning, software
                  engineering, and system thinking, with increasing emphasis on
                  robustness, traceability, and operational decision-making.
                </TimelineItem>
              </RevealItem>
              ...
              <RevealItem>
                <TimelineItem
                  ...
                  achievements={[
                    ...
                    "Built extensible mobile-first architecture with APIs",
                  ]}
                >
                  Built a mobile-first application that connects concert and event
                  discovery with multi-modal travel planning, allowing users to
                  plan complete journeys around events instead of raw routes.
                </TimelineItem>
              </RevealItem>
...
function TimelineCard({
  ...
  const badgeStyles = {
    ...
    orange: "from-amber-400 to-orange-500 text-black",
    blue: "from-sky-400 to-blue-500 text-black",
  }
        ...
        {badge && (
          <span
            className={`
              ...
              bg-gradient-to-r ${badgeStyles[badge.variant]}
        ...
        <div className="space-y-4 pt-2">
          ...
          <div className="space-y-3">
            {achievements.map((item, i) => (
              <div
                key={i}
                className="flex gap-4 items-start rounded-xl bg-white/5 border border-white/10 p-4 transition-all duration-300 hover:border-violet-400/40 hover:bg-violet-500/10"
              >
                <span className="mt-1 h-2.5 w-2.5 rounded-full bg-gradient-to-br from-amber-400 to-orange-500 shadow-[0_0_12px_rgba(251,191,36,0.6)]" />
